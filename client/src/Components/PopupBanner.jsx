...
const PopupBanner = () => {
  ...
  return (
    <div className="fixed top-22 h-fit right-0 animate-bounce  z-150 md:left-auto  bg-gradient-to-r from-cyan-200  to-cyan-300 rounded-lg shadow-xl overflow-hidden animate-slide-up">
