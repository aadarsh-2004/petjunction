...
const MembershipSection = () => {
  const plans = [
    ...
    },
    {
      ...
      price: "$99",
      period: "/month",
      description: "Complete care package for the ultimate pet experience",
      features: [
        "Daily dog walks",
  ...
  return (
    <div className="py-16 bg-gradient-to-tr from-amber-100 via-orange-50 to-amber-100">
      <div className="container mx-auto px-4 ">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan) => (
            <div
              key={plan.title}
              className={`relative rounded-2xl ${plan.color} p-6 shadow-lg transform transition-transform hover:-translate-y-1 hover:shadow-xl`}
            >
              {plan.popular && (
