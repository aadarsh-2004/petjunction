      ...
      <div className="relative max-w-4xl mt-24 mx-auto p-8 bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="text-center mb-8 relative">
          <div className="bg-white text-black bg-clip-text">
            <h1 className="text-4xl font-bold mb-2">Book Your Pet Service with Ease 🐾</h1>
          </div>
          <p className="text-gray-600 text-lg mb-4">
            Fill out the form below to get an instant quote and book an appointment with our pet care specialists in Udaipur. We are committed to providing the best care for your furry friend!
          </p>
